    ...
    return (
        <div className="flex justify-end my-6">
            <div className="mr-10 flex items-center gap-2">
                <label className="text-gray-500 font-semibold" htmlFor="rows_number">Rows:</label>
                <select onChange={handleRowsChange} value={rows} id="rows_number" className="block w-full px-4 py-1 text-gray-700 bg-white border border-gray-200 rounded-xl"
                >
