          ...
          <form onSubmit={handleSubmit(handleDataPost)}>
            ...
            <div className="grid grid-cols-1 gap-6 mt-4 md:grid-cols-2">
              <div>
                ...
                <input placeholder="Product Name...." {...register("title", { required: 'Product Name is required' })} id="title" type="text" className="block w-full px-2 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-xl" />
                {errors.title && <p className='text-red-600'>{errors.title?.message}</p>}
              </div>

              <div className="mt-3">
                <label className="font-semibold" htmlFor="color"> Select Color<span className="text-red-500">*</span> </label>
                <Select
                  id="color"
                  name="color"
                  required
            ...
            <div className="mt-4">
              ...
              <textarea rows={3} placeholder="Description...." {...register("description", { required: 'Description is required' })} id="description" type="text" className="block w-full px-2 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-xl" />
            ...
            <div className="grid grid-cols-1 gap-6 mt-4 md:grid-cols-2">
              ...
              <div>
                ...
                <input placeholder="0.000" {...register("price", { required: "Price must be required" })} id="price" type="number" className="block w-full px-2 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-xl" />
                {errors.price && <p className='text-red-600'>{errors.price?.message}</p>}
              </div>

              <div>
                <label className="font-semibold" htmlFor="discount_price">Discount Price</label>
                <input placeholder="0.000" {...register("discount_price")} id="discount_price" type="number" className="block w-full px-2 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-xl" />
              </div>
            ...
            <div className="grid grid-cols-1 gap-6 mt-4 md:grid-cols-3">
...

              {
                isOpenSubCategory &&
                <div>
                  <label className="font-semibold" htmlFor="subCategoryId">Sub Category Type</label>
                  <Select
                    id="subCategoryId"
                    required
                    name="subCategoryId"
            ...
            <div className="grid grid-cols-1 gap-6 mt-4 md:grid-cols-3">
              ...
              <div>
                <label className="font-semibold" htmlFor="collectionId">Collection Type</label>
                <Select
                  id="collectionId"
                  name="collectionId"
              ...
              <div>
                <label className="font-semibold" htmlFor="styleId">Style Type</label>
                <Select
                  id="styleId"
                  name="styleId"
              ...
              <div>
                <label className="font-semibold" htmlFor="featureId">Feature Type</label>
                <Select
                  id="featureId"
                  name="featureId"
            ...
            <div className="mt-3">
              <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
                ...
                <div>
                  <label className="font-semibold" htmlFor="product_video"> Product Video</label>
                  <input
