                ...
                <tbody className="divide-y divide-gray-200">
                    {menuTypes?.data?.map((menu) => (
                        <tr key={menu?._id}>
                            ...
                            <MdDeleteForever onClick={() =>handleDeleteMenu(menu)} className='cursor-pointer text-red-500 hover:text-red-300' size={25} />
                            <FiEdit onClick={() =>updateMenuModal(menu)} className='cursor-pointer text-gray-500 hover:text-gray-300' size={25} />
                            </td>
                        </tr>
                    ))}
                </tbody>
...
                </div>
            ...
            {/* Update menu */}
            {
                menuUpdateModal && <UpdateMenuType setMenuUpdateModal={setMenuUpdateModal} menuUpdateModalValue={menuUpdateModalValue} refetch={refetch} />
            }
        </div>
    );
};
