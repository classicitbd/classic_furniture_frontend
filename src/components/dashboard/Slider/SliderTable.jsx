...
const SliderTable = ({ sliders, refetch }) => {
  ...
  return (
    <div className="my-12">
              ...
              <div className="p-6">
                <div className="mt-4">
                  <div className="flex items-center justify-between">
                    ...
                    />
                    <FiEdit
                      onClick={() => updateSliderModal(slider)}
      ...
      {addSliderModalOpen && (
        <AddSlider
          setAddSliderModalOpen={setAddSliderModalOpen}
          refetch={refetch}
        />
      )}
      {/* Update Slider */}
      {sliderUpdateModal && (
        <UpdateSlider
          setSliderUpdateModal={setSliderUpdateModal}
          sliderUpdateModalValue={sliderUpdateModalValue}
          refetch={refetch}
        />
      )}
    </div>
