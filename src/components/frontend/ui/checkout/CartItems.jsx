...
import { decrementQuantity, incrementQuantity, removeFromCart } from "../../../../redux/feature/cart/cartSlice";
          ...
          <div className="border rounded mb-4 flex justify-between " key={index}>
            <div className="flex  flex-col sm:flex-row md:px-0 px-4  gap-4">
              ...
              <div className="py-1.5 md:px-4 ">
                ...
                {
                  product?.product_partial_payment && product?.product_partial_payment == true &&
                  <p className="py-1">Partial Payment: {product?.product_partial_payment_amount}</p>
                }
              </div>
            </div>
            <dir>
              ...
              } className="flex gap-2 px-2  bg-red-500 hover:bg-red-600 duration-200 text-white p-1 rounded my-4 text-[12px]">
