    ...
    <section className="grid grid-cols-1 lg:grid-cols-2 sm:mx-5">
      ...
      <div className="px-5 md:px-10 py-5">
        ...
        <div className="px-4">
          ...
          <div className="py-5 md:py-10 gap-1 md:gap-2 items-center flex">
            {product?.data?.product_video && (
              <button
                onClick={() => openModal("video")}
                className="relative inline-flex items-center justify-start px-1 md:px-4 py-1.5 overflow-hidden font-medium transition-all bg-primaryColor rounded group"
              >
